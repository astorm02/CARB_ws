...
def generate_launch_description():
    ...
    obj_detection_node = Node(
        ...
        parameters=[
            {'color_low': [5, 150, 150]},{'color_high': [20, 255, 255]}, {'object_size_min':200}
        ],
        output="screen"
    )
    # {'color_low': [10, 80, 80]},{'color_high': [35, 100, 100]}
    ...
    goal_detection_node = Node(
        ...
        parameters=[
            {'color_low': [100, 150, 150]},{'color_high': [125, 255, 255]}, {'object_size_min':200}
        ],
        output="screen"
    )
    # {'color_low': [200, 80, 80]},{'color_high': [250, 100, 100]}
